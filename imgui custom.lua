...
function Library:change_theme(toTheme)
	...
	Library.DisplayName.Text = "Bem-vindo, <font color='rgb(" ..  math.floor(c.R*255) .. "," .. math.floor(c.G*255) .. "," .. math.floor(c.B*255) .. ")'> <b>" .. LocalPlayer.DisplayName .. "</b> </font>"
...
function Library:create(options)
	...
	settingsTab:keybind{
		Name = "Tecla de Alternância",
		Description = "Tecla para mostrar/ocultar a interface.",
	...
	settingsTab:toggle{
		Name = "Bloquear Arrastar",
		Description = "Garante que você não possa arrastar a interface para fora da janela.",
		StartingState = true,
	...
	settingsTab:slider{
		Name = "Velocidade de Arrastar da Interface",
		Description = "Quão suave o arrastar parece.",
		Max = 20,
		Default = 14,
	...
	creditsTab:credit{Name = "Abstract", Description = "Desenvolvedor da Biblioteca de Interface", Discord = "Abstract#8007", V3rmillion = "AbstractPoo"}
	creditsTab:credit{Name = "Deity", Description = "Desenvolvedor da Biblioteca de Interface", Discord = "Deity#0228", V3rmillion = "0xDEITY"}
	creditsTab:credit{Name = "Repository", Description = "Repositório da Biblioteca de Interface", Github="https://github.com/deeeity/mercury-lib/blob/master/src.lua"}
